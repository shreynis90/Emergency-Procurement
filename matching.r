...
valuecuts1_0 = c(13.051,13.955,15.105)
...
mat1_0 <- cem(treatment = "treatcon", data = temp1_0, drop = "lot_bidsCount",cutpoints = list(log_contractvalue=valuecuts1_0),  grouping = list(buyer_buyerType= buyer_buyerType.grp))
mat1_0
mat1_0$w
...
buyer_buyerType.grp<- list(c("REGIONAL_AUTHORITY", "REGIONAL_AGENCY", "UTILITIES"), c("NATIONAL_AUTHORITY"),c("OTHER"), c("PUBLIC_BODY"), c("NA",NA))
mat1_1 <- cem(treatment = "treatcon", data = temp1_1, drop = "lot_bidsCount",cutpoints = list(log_contractvalue=valuecuts1_1), grouping = list(buyer_buyerType= buyer_buyerType.grp))
mat1_1
...
buyer_buyerType.grp<- list(c("REGIONAL_AUTHORITY", "REGIONAL_AGENCY", "UTILITIES"), c("NATIONAL_AUTHORITY"),c("OTHER"), c("PUBLIC_BODY"), c("NA",NA))
mat2_0 <- cem(treatment = "treatcon", data = temp2_0, drop = "lot_bidsCount",cutpoints = list(log_contractvalue=valuecuts2_0), grouping = list(buyer_buyerType= buyer_buyerType.grp))
mat2_0
...
buyer_buyerType.grp<- list(c("REGIONAL_AUTHORITY", "REGIONAL_AGENCY", "UTILITIES"), c("NATIONAL_AUTHORITY"),c("OTHER"), c("PUBLIC_BODY"), c("NA",NA))
mat2_1 <- cem(treatment = "treatcon", data = temp2_1, drop = "lot_bidsCount",cutpoints = list(log_contractvalue=valuecuts2_1), grouping = list(buyer_buyerType= buyer_buyerType.grp))
mat2_1
...
buyer_buyerType.grp<- list(c("REGIONAL_AUTHORITY", "REGIONAL_AGENCY", "UTILITIES"), c("NATIONAL_AUTHORITY"),c("OTHER"), c("PUBLIC_BODY"), c("NA",NA))
mat3_0 <- cem(treatment = "treatcon", data = temp3_0, drop = "lot_bidsCount",cutpoints = list(log_contractvalue=valuecuts3_0), grouping = list(buyer_buyerType= buyer_buyerType.grp))
mat3_0
...
buyer_buyerType.grp<- list(c("REGIONAL_AUTHORITY", "REGIONAL_AGENCY", "UTILITIES"), c("NATIONAL_AUTHORITY"),c("OTHER"), c("PUBLIC_BODY"), c("NA",NA))
mat3_1 <- cem(treatment = "treatcon", data = temp3_1, drop = "lot_bidsCount",cutpoints = list(log_contractvalue=valuecuts3_1), grouping = list(buyer_buyerType= buyer_buyerType.grp))
mat3_1
...
buyer_buyerType.grp<- list(c("REGIONAL_AUTHORITY", "REGIONAL_AGENCY", "UTILITIES"), c("NATIONAL_AUTHORITY"),c("OTHER"), c("PUBLIC_BODY"), c("NA",NA))
mat4_0 <- cem(treatment = "treatcon", data = temp4_0, drop = "lot_bidsCount",cutpoints = list(log_contractvalue=valuecuts4_0), grouping = list(buyer_buyerType= buyer_buyerType.grp))
mat4_0
...
buyer_buyerType.grp<- list(c("REGIONAL_AUTHORITY", "REGIONAL_AGENCY", "UTILITIES"), c("NATIONAL_AUTHORITY"),c("OTHER"), c("PUBLIC_BODY"), c("NA",NA))
mat4_1 <- cem(treatment = "treatcon", data = temp4_1, drop = "lot_bidsCount",cutpoints = list(log_contractvalue=valuecuts4_1), grouping = list(buyer_buyerType= buyer_buyerType.grp))
mat4_1
...
buyer_buyerType.grp<- list(c("REGIONAL_AUTHORITY", "REGIONAL_AGENCY", "UTILITIES"), c("NATIONAL_AUTHORITY"),c("OTHER"), c("PUBLIC_BODY"), c("NA",NA))
mat5_0 <- cem(treatment = "treatcon", data = temp5_0, drop = "lot_bidsCount",cutpoints = list(log_contractvalue=valuecuts5_0), grouping = list(buyer_buyerType= buyer_buyerType.grp))
mat5_0
...
mat5_1 <- cem(treatment = "treatcon", data = temp5_1, drop = "lot_bidsCount",cutpoints = list(log_contractvalue=valuecuts5_1), grouping = list(buyer_buyerType= buyer_buyerType.grp))
mat5_1
...
dv1_did<- lm(lot_bidsCount ~ treatcon + timing + did, data = dv1, weights = aftermatchweight)
summary.lm(dv1_did)
table(dv1$treatcon)
