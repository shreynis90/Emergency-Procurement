...
#Matching
vars <- c("treatcon","buyer_buyerType", "tender_mainCpv", "procedureintegrity", "log_contractvalue", "meanprocedureintegrity", "contractyear")
temp1_0<-disaster1_pretreat[vars]
vars2<- c("buyer_buyerType", "tender_mainCpv", "log_contractvalue","contractyear", "meanprocedureintegrity")
...
vars2<- c("buyer_buyerType", "tender_mainCpv", "log_contractvalue", "meanprocedureintegrity","contractyear")
...
disaster1_did<- glm(procedureintegrity ~ treatcon + timing + did, data = disaster1_matched, family="binomial", weights = aftermatchweight)
...
disaster2_did<- glm(procedureintegrity ~ treatcon + timing + did, data = disaster2_matched, family="binomial", weights = aftermatchweight)
...
disaster3_did<- glm(procedureintegrity ~ treatcon + timing + did, data = disaster3_matched,family="binomial", weights = aftermatchweight)
...
disaster4_did<- glm(procedureintegrity ~ treatcon + timing + did, data = disaster4_matched, family ="binomial",weights = aftermatchweight)
...
disaster5_did<- glm(procedureintegrity ~ treatcon + timing + did, data = disaster5_matched,family="binomial", weights = aftermatchweight)
