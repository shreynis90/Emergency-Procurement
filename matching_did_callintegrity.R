...
italy$callintegrity <- ifelse(italy$tender_indicator_INTEGRITY_CALL_FOR_TENDER_PUBLICATION
 == 0, 1, 0)
...
#Matching
vars_bf <- c("timing", "tender_mainCpv", "callintegrity", "log_contractvalue", "meancallintegrity","contractmonth","buyer_buyerType")

temp1_0<-disaster1[vars_bf]
vars2_bf<- c("log_contractvalue","meancallintegrity")
...
mat1_0 <- cem(treatment = "timing", data = temp1_0, drop = "callintegrity",cutpoints = list(log_contractvalue=valuecuts1_0), eval.imbalance = TRUE)
mat1_0
mat1_0$w
est1_0 <- att(mat1_0, callintegrity ~ timing, data = temp1_0)
est1_0
...
italy_disaster1_out$tender_mainCpv <- as.integer(italy_disaster1_out$tender_mainCpv)
italy_disaster1_out$tender_mainCpv
...
disaster1_in_pretreat = subset(disaster1_in_pretreat0, select = -c(aftermatchweight,aftermatchtreat,meancallintegrity) )

disaster1_in_out_pretreat <- rbind(disaster1_out_pretreat0,disaster1_in_pretreat) 

vars <- c("loc", "tender_mainCpv", "callintegrity", "log_contractvalue","contractmonth","buyer_buyerType")
temp1_0_did<-disaster1_in_out_pretreat[vars]
vars2<- c("loc", "tender_mainCpv", "log_contractvalue","contractmonth","buyer_buyerType")
...
valuecuts1_0_did = c(13.940)
mat1_0_did <- cem(treatment = "loc", data = temp1_0_did, drop = "callintegrity",cutpoints = list(log_contractvalue=valuecuts1_0_did), eval.imbalance = TRUE)
mat1_0_did
mat1_0_did$w
...
disaster1_in_posttreat = subset(disaster1_in_posttreat0, select = -c(aftermatchweight,aftermatchtreat,meancallintegrity) )

disaster1_in_out_posttreat <- rbind(disaster1_out_posttreat0, disaster1_in_posttreat)
...
valuecuts1_1_did = c(14.58)
mat1_1_did <- cem(treatment = "loc", data = temp1_1_did, drop = "callintegrity",cutpoints = list(log_contractvalue=valuecuts1_1_did), eval.imbalance = TRUE)
mat1_1_did
mat1_1_did$w
...
mat2_0 <- cem(treatment = "timing", data = temp2_0, drop = "callintegrity",cutpoints = list(log_contractvalue=valuecuts2_0), eval.imbalance = TRUE)
mat2_0
est2_0 <- att(mat2_0, callintegrity ~ timing, data = temp2_0)
est2_0
...
disaster2_in_pretreat = subset(disaster2_in_pretreat0, select = -c(aftermatchweight,aftermatchtreat,meancallintegrity) )

disaster2_in_out_pretreat <- rbind(disaster2_out_pretreat0,disaster2_in_pretreat) 

temp2_0_did<-disaster2_in_out_pretreat[vars]
temp2_0_did<- as.data.frame(temp2_0_did)
imbalance(group=temp2_0_did$loc, data=temp2_0_did[vars2])
summary(temp2_0_did$log_contractvalue)
valuecuts2_0_did = c(14.229)
mat2_0_did <- cem(treatment = "loc", data = temp2_0_did, drop = "callintegrity",cutpoints = list(log_contractvalue=valuecuts2_0_did), eval.imbalance = TRUE)
mat2_0_did
mat2_0_did$w
...
disaster2_in_posttreat = subset(disaster2_in_posttreat0, select = -c(aftermatchweight,aftermatchtreat,meancallintegrity) )

disaster2_in_out_posttreat <- rbind(disaster2_out_posttreat0, disaster2_in_posttreat)
...
valuecuts2_1_did = c(14.63)
mat2_1_did <- cem(treatment = "loc", data = temp2_1_did, drop = "callintegrity",cutpoints = list(log_contractvalue=valuecuts2_1_did), eval.imbalance = TRUE)
mat2_1_did
mat2_1_did$w
...
imbalance(group=temp3_0$timing, data=temp3_0[vars2_bf])
summary(temp3_0$log_contractvalue)
valuecuts3_0 <- c(14.23)
mat3_0 <- cem(treatment = "timing", data = temp3_0, drop = "callintegrity",cutpoints = list(log_contractvalue=valuecuts3_0), eval.imbalance = TRUE)
mat3_0
est3_0 <- att(mat3_0, callintegrity ~ timing, data = temp3_0)
est3_0
...
disaster3_in_pretreat = subset(disaster3_in_pretreat0, select = -c(aftermatchweight,aftermatchtreat,meancallintegrity) )

disaster3_in_out_pretreat <- rbind(disaster3_out_pretreat0,disaster3_in_pretreat) 

temp3_0_did<-disaster3_in_out_pretreat[vars]
temp3_0_did<- as.data.frame(temp3_0_did)
imbalance(group=temp3_0_did$loc, data=temp3_0_did[vars2])
summary(temp3_0_did$log_contractvalue)
valuecuts3_0_did = c(14.286)
mat3_0_did <- cem(treatment = "loc", data = temp3_0_did, drop = "callintegrity",cutpoints = list(log_contractvalue=valuecuts3_0_did), eval.imbalance = TRUE)
mat3_0_did
mat3_0_did$w
...
disaster3_in_posttreat = subset(disaster3_in_posttreat0, select = -c(aftermatchweight,aftermatchtreat,meancallintegrity) )

disaster3_in_out_posttreat <- rbind(disaster3_out_posttreat0, disaster3_in_posttreat)


temp3_1_did<-disaster3_in_out_posttreat[vars]
temp3_1_did<- as.data.frame(temp3_1_did)
imbalance(group=temp3_1_did$loc, data=temp3_1_did[vars2])
summary(temp3_1_did$log_contractvalue)
valuecuts3_1_did = c(14.66)
mat3_1_did <- cem(treatment = "loc", data = temp3_1_did, drop = "callintegrity",cutpoints = list(log_contractvalue=valuecuts3_1_did), eval.imbalance = TRUE)
mat3_1_did
mat3_1_did$w
...
imbalance(group=temp4_0$timing, data=temp4_0[vars2_bf])
summary(temp4_0$log_contractvalue)
valuecuts4_0 = c(13.76)
buyer_buyerType.grp<- list(c("REGIONAL_AUTHORITY", "REGIONAL_AGENCY", "UTILITIES"), c("NATIONAL_AUTHORITY"),c("OTHER"), c("PUBLIC_BODY"), c("NA",NA))
mat4_0 <- cem(treatment = "timing", data = temp4_0, drop = "callintegrity",cutpoints = list(log_contractvalue=valuecuts4_0), eval.imbalance = TRUE)
mat4_0
est4_0 <- att(mat4_0, callintegrity ~ timing, data = temp4_0)
est4_0
...
disaster4_in_pretreat = subset(disaster4_in_pretreat0, select = -c(aftermatchweight,aftermatchtreat,meancallintegrity) )

disaster4_in_out_pretreat <- rbind(disaster4_out_pretreat0,disaster4_in_pretreat) 

temp4_0_did<-disaster4_in_out_pretreat[vars]
temp4_0_did<- as.data.frame(temp4_0_did)
imbalance(group=temp4_0_did$loc, data=temp4_0_did[vars2])
summary(temp4_0_did$log_contractvalue)
valuecuts4_0_did = c(14.30)
mat4_0_did <- cem(treatment = "loc", data = temp4_0_did, drop = "callintegrity",cutpoints = list(log_contractvalue=valuecuts4_0_did), eval.imbalance = TRUE)
mat4_0_did
mat4_0_did$w
...
disaster4_in_posttreat = subset(disaster4_in_posttreat0, select = -c(aftermatchweight,aftermatchtreat,meancallintegrity) )

disaster4_in_out_posttreat <- rbind(disaster4_out_posttreat0, disaster4_in_posttreat)


temp4_1_did<-disaster4_in_out_posttreat[vars]
temp4_1_did<- as.data.frame(temp4_1_did)
imbalance(group=temp4_1_did$loc, data=temp4_1_did[vars2])
summary(temp4_1_did$log_contractvalue)
valuecuts4_1_did = c(13.61,14.82)
mat4_1_did <- cem(treatment = "loc", data = temp4_1_did, drop = "callintegrity",cutpoints = list(log_contractvalue=valuecuts4_1_did), eval.imbalance = TRUE)
mat4_1_did
mat4_1_did$w
...
buyer_buyerType.grp<- list(c("REGIONAL_AUTHORITY", "REGIONAL_AGENCY", "UTILITIES"), c("NATIONAL_AUTHORITY"),c("OTHER"), c("PUBLIC_BODY"), c("NA",NA))
mat5_0 <- cem(treatment = "timing", data = temp5_0, drop = "callintegrity",cutpoints = list(log_contractvalue=valuecuts5_0), eval.imbalance = TRUE)
mat5_0
...
disaster5_in_pretreat = subset(disaster5_in_pretreat0, select = -c(aftermatchweight,aftermatchtreat,meancallintegrity) )

disaster5_in_out_pretreat <- rbind(disaster5_out_pretreat0,disaster5_in_pretreat) 

temp5_0_did<-disaster5_in_out_pretreat[vars]
temp5_0_did<- as.data.frame(temp5_0_did)
imbalance(group=temp5_0_did$loc, data=temp5_0_did[vars2])
summary(temp5_0_did$log_contractvalue)
valuecuts5_0_did = c(14.35)
mat5_0_did <- cem(treatment = "loc", data = temp5_0_did, drop = "callintegrity",cutpoints = list(log_contractvalue=valuecuts5_0_did), eval.imbalance = TRUE)
mat5_0_did
mat5_0_did$w
...
disaster5_in_posttreat = subset(disaster5_in_posttreat0, select = -c(aftermatchweight,aftermatchtreat,meancallintegrity) )

disaster5_in_out_posttreat <- rbind(disaster5_out_posttreat0, disaster5_in_posttreat)


temp5_1_did<-disaster5_in_out_posttreat[vars]
temp5_1_did<- as.data.frame(temp5_1_did)
imbalance(group=temp5_1_did$loc, data=temp5_1_did[vars2])
summary(temp5_1_did$log_contractvalue)
valuecuts5_1 = c(14.80)
mat5_1_did <- cem(treatment = "loc", data = temp5_1_did, drop = "callintegrity",cutpoints = list(log_contractvalue=valuecuts5_1), eval.imbalance = TRUE)
mat5_1_did
mat5_1_did$w

disaster5_in_out_posttreat$aftermatchtreat <- mat5_1_did$matched
disaster5_in_out_posttreat$aftermatchweight <- mat5_1_did$w
disaster5_did_1 <- disaster4_in_out_posttreat %>% filter(aftermatchtreat == TRUE)
...
matched_comparison<- t.test(dv1_post$callintegrity,dv1_pre$callintegrity, paired = FALSE, conf.level = 0.90)
matched_comparison

##Diff-in-diff ----

dv2 <- rbind(disaster1_did_final, disaster2_did_final, disaster3_did_final, disaster4_did_final, disaster5_did_final)
didreg = lm(callintegrity ~ loc*timing, data = dv2)
summary(didreg)
