...
italy <- italy %>%
  mutate(days_difference = as.integer(difftime(tender_bidDeadline, tender_publications_firstCallForTenderDate, units = "days")))



italy<- italy %>% filter(!is.na(days_difference))

italy <- italy %>%
  mutate(advertintegrity = days_difference/365)
