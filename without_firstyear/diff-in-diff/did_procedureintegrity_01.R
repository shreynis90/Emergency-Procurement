...
#Matching
vars_bf <- c("ID","timing", "tender_mainCpv", "procedureintegrity", "log_contractvalue", "meanprocedureintegrity","contractmonth","buyer_buyerType")

temp1_0<-disaster1[vars_bf]
vars2_bf<- c("timing", "tender_mainCpv", "log_contractvalue", "meanprocedureintegrity","contractmonth","buyer_buyerType")
...
mat1_0 <- cem(treatment = "timing", data = temp1_0, drop = c("ID","procedureintegrity"),cutpoints = list(log_contractvalue=valuecuts1_0), eval.imbalance = TRUE)
mat1_0
...
disaster1_out_pretreat <- disaster1_out_pretreat_1 %>% group_by(buyer_name) %>% mutate(meanprocedureintegrity = mean(procedureintegrity)) #pretreament average of the number of bidders
common1_1_out<- cbind.data.frame(disaster1_out_pretreat$buyer_name, disaster1_out_pretreat$meanprocedureintegrity)
common1_1_out<- distinct(common1_1_out)
names(common1_1_out)[1]<-paste("buyer_name")
names(common1_1_out)[2]<-paste("meanprocedureintegrity")
...
vars <- c("ID","loc", "tender_mainCpv", "procedureintegrity", "log_contractvalue","buyer_buyerType","contractyear","contractmonth")
temp1_0_did<-disaster1_in_out_pretreat[vars]
vars2<- c("loc", "tender_mainCpv", "log_contractvalue","contractmonth","buyer_buyerType","meanprocedureintegrity")
...
summary(temp1_0_did$meanprocedureintegrity)
valuecuts1_0_did = c(15,14)
mat1_0_did <- cem(treatment = "loc", data = temp1_0_did, drop = c("ID","procedureintegrity"),cutpoints = list(log_contractvalue=valuecuts1_0_did), eval.imbalance = TRUE)
mat1_0_did
...
summary(temp1_1_did$meanprocedureintegrity)
valuecuts1_1_did = c(13.319,14.331)
mat1_1_did <- cem(treatment = "loc", data = temp1_1_did, drop = c("ID","procedureintegrity"),cutpoints = list(log_contractvalue=valuecuts1_1_did), eval.imbalance = TRUE)
mat1_1_did
...
mat2_0 <- cem(treatment = "timing", data = temp2_0, drop = c("ID","procedureintegrity"), eval.imbalance = TRUE)
mat2_0
...
disaster2_out_pretreat <- disaster2_out_pretreat_1 %>% group_by(buyer_name) %>% mutate(meanprocedureintegrity = mean(procedureintegrity)) #pretreament average of the number of bidders
common2_1_out<- cbind.data.frame(disaster2_out_pretreat$buyer_name, disaster2_out_pretreat$meanprocedureintegrity)
common2_1_out<- distinct(common2_1_out)
names(common2_1_out)[1]<-paste("buyer_name")
names(common2_1_out)[2]<-paste("meanprocedureintegrity")
...
summary(temp2_0_did$meanprocedureintegrity)
...
mat2_0_did <- cem(treatment = "loc", data = temp2_0_did, drop = c("ID","procedureintegrity"),cutpoints = list(log_contractvalue = valuecuts2_0_did),grouping = list(contractmonth = month.grp, buyer_buyerType = buyer_buyerType.grp),eval.imbalance = TRUE)
mat2_0_did
...
t.test(dis2_mean_in$procedureintegrity,dis2_mean_out$procedureintegrity, paired = FALSE, conf.level = 0.90)
...
valuecuts2_1_did = c(13.46,14.58,15.97)

mat2_1_did <- cem(treatment = "loc", data = temp2_1_did, drop = c("ID","procedureintegrity"),cutpoints = list(log_contractvalue=valuecuts2_1_did), eval.imbalance = TRUE)
mat2_1_did
...
valuecuts3_0 <- c(20)
mat3_0 <- cem(treatment = "timing", data = temp3_0, drop = c("ID","procedureintegrity"),cutpoints = list(log_contractvalue = valuecuts3_0), eval.imbalance = TRUE)
mat3_0
...
disaster3_out_pretreat <- disaster3_out_pretreat_1 %>% group_by(buyer_name) %>% mutate(meanprocedureintegrity = mean(procedureintegrity)) #pretreament average of the number of bidders
common3_1_out<- cbind.data.frame(disaster3_out_pretreat$buyer_name, disaster3_out_pretreat$meanprocedureintegrity)
common3_1_out<- distinct(common3_1_out)
names(common3_1_out)[1]<-paste("buyer_name")
names(common3_1_out)[2]<-paste("meanprocedureintegrity")
...
mat3_0_did <- cem(treatment = "loc", data = temp3_0_did, drop = c("ID","procedureintegrity"),cutpoints = list(log_contractvalue=valuecuts3_0_did), eval.imbalance = TRUE)
mat3_0_did
...
t.test(dis3_mean_in$procedureintegrity,dis3_mean_out$procedureintegrity, paired = FALSE, conf.level = 0.90)
...
valuecuts3_1_did = c(13.44)
mat3_1_did <- cem(treatment = "loc", data = temp3_1_did, drop = c("ID","procedureintegrity"),cutpoints = list(log_contractvalue=valuecuts3_1_did), eval.imbalance = TRUE)
mat3_1_did
...
summary(temp4_0$meanprocedureintegrity)
...
mat4_0 <- cem(treatment = "timing", data = temp4_0, drop = c("ID","procedureintegrity"),cutpoints = list(log_contractvalue=valuecuts4_0 ), eval.imbalance = TRUE)
mat4_0
...
disaster4_out_pretreat <- disaster4_out_pretreat_1 %>% group_by(buyer_name) %>% mutate(meanprocedureintegrity = mean(procedureintegrity)) #pretreament average of the number of bidders
common4_1_out<- cbind.data.frame(disaster4_out_pretreat$buyer_name, disaster4_out_pretreat$meanprocedureintegrity)
common4_1_out<- distinct(common4_1_out)
names(common4_1_out)[1]<-paste("buyer_name")
names(common4_1_out)[2]<-paste("meanprocedureintegrity")
...
summary(temp4_0_did$meanprocedureintegrity)
valuecuts4_0_did = c(13.311,11,12)
mat4_0_did <- cem(treatment = "loc", data = temp4_0_did, drop = c("ID","procedureintegrity"),cutpoints = list(log_contractvalue=valuecuts4_0_did), eval.imbalance = TRUE)
mat4_0_did
...
#t.test(dis4_mean_in$procedureintegrity,dis4_mean_out$procedureintegrity, paired = FALSE, conf.level = 0.90)
...
valuecuts4_1_did = c(13.59,14.82,16.07)
mat4_1_did <- cem(treatment = "loc", data = temp4_1_did, drop = c("ID","procedureintegrity"),cutpoints = list(log_contractvalue=valuecuts4_1_did), eval.imbalance = TRUE)
mat4_1_did
...
mat5_0 <- cem(treatment = "timing", data = temp5_0, drop = c("ID","procedureintegrity"), cutpoints = list(log_contractvalue = valuecuts5_0), grouping = list(contractmonth = month.grp), eval.imbalance = TRUE)
mat5_0
...
disaster5_out_pretreat <- disaster5_out_pretreat_1 %>% group_by(buyer_name) %>% mutate(meanprocedureintegrity = mean(procedureintegrity)) #pretreament average of the number of bidders
common5_1_out<- cbind.data.frame(disaster5_out_pretreat$buyer_name, disaster5_out_pretreat$meanprocedureintegrity)
common5_1_out<- distinct(common5_1_out)
names(common5_1_out)[1]<-paste("buyer_name")
names(common5_1_out)[2]<-paste("meanprocedureintegrity")
...
valuecuts5_0_did <- c(13.59,13.58,13.6,14.361, 14.4, 14,11)
month.grp <- list(c("1"),c( "2","3"),c("4","5","6"), c("7", "8","9","10", "11","12"),c(NA))
buyer_buyerType.grp<- list(c("REGIONAL_AUTHORITY", "REGIONAL_AGENCY"), c("UTILITIES"), c("NATIONAL_AUTHORITY"), c("OTHER"),c("PUBLIC_BODY","NA"))
mat5_0_did <- cem(treatment = "loc", data = temp5_0_did, drop = c("ID","procedureintegrity"), cutpoints = list(log_contractvalue = valuecuts5_0_did),grouping = list(contractmonth = month.grp, buyer_buyerType = buyer_buyerType.grp), eval.imbalance = TRUE)
mat5_0_did
...
t.test(dis5_mean_in$procedureintegrity,dis5_mean_out$procedureintegrity, paired = FALSE, conf.level = 0.90)
...
valuecuts5_1_did <- c(13.59,13.58,13.6,14.361, 14.4)
mat5_1_did <- cem(treatment = "loc", data = temp5_1_did, drop = c("ID","procedureintegrity"), cutpoints = list(log_contractvalue = valuecuts5_1_did),grouping = list(contractmonth = month.grp, buyer_buyerType = buyer_buyerType.grp), eval.imbalance = TRUE)
mat5_1_did
...
saveRDS(matched_comparison,'tables/robustness/table_22/1_t_test_did_procedureintegrity.rds')
...
didreg = lm(procedureintegrity ~ loc*timing +  contractyear + contractmonth + buyer_buyerType + tender_mainCpv + log_contractvalue, data = dv4, weights = aftermatchweight)
summary(didreg)

dv4_pre_in <- dv3 %>% filter(timing == 0 & loc == 1)
dv4_pre_out <- dv3 %>% filter(timing == 0 & loc == 0)

t.test(dv4_pre_in$procedureintegrity,dv4_pre_out$procedureintegrity, paired = FALSE, conf.level = 0.90)
...
matched_comparison_twoyear <- t.test(d_twoyearpost$procedureintegrity,d_oneyearpre$procedureintegrity, paired = FALSE, conf.level = 0.90)
...
didreg2 = lm(procedureintegrity ~ loc*timing +  contractyear + contractmonth + buyer_buyerType + tender_mainCpv + log_contractvalue, data = dv4, weights = aftermatchweight)

summary(didreg2)

saveRDS(didreg2, 'tables/robustness/table_23/1_procedureintegrity_did.Rds')
...
saveRDS(summary_coeftest, 'tables/robustness/table_23/1_procedureintegrity_did_clustered_se.Rds')
