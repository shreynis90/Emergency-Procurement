...
disaster1_pretreat <- disaster1_pretreat_1 %>% group_by(buyer_name) %>% mutate(meancallintegrity = mean(callintegrity)) #pretreament average of the number of bidders
common1_1<- cbind.data.frame(disaster1_pretreat$buyer_name, disaster1_pretreat$meancallintegrity)
common1_1<- distinct(common1_1)
names(common1_1)[1]<-paste("buyer_name")
names(common1_1)[2]<-paste("meancallintegrity")
...
#Matching
vars_bf <- c("ID","timing", "tender_mainCpv", "callintegrity", "log_contractvalue", "meancallintegrity","contractmonth","buyer_buyerType")
...
disaster1_out_pretreat <- disaster1_out_pretreat_1 %>% group_by(buyer_name) %>% mutate(meancallintegrity = mean(callintegrity)) #pretreament average of the number of bidders
common1_1_out<- cbind.data.frame(disaster1_out_pretreat$buyer_name, disaster1_out_pretreat$meancallintegrity)
common1_1_out<- distinct(common1_1_out)
names(common1_1_out)[1]<-paste("buyer_name")
names(common1_1_out)[2]<-paste("meancallintegrity")
...
vars <- c("ID","loc", "tender_mainCpv", "callintegrity", "log_contractvalue","buyer_buyerType","contractyear","contractmonth")
...
mat1_0_did <- cem(treatment = "loc", data = temp1_0_did, drop = c("ID","callintegrity"),cutpoints = list(log_contractvalue=valuecuts1_0_did), eval.imbalance = TRUE)
mat1_0_did
...
mat1_1_did <- cem(treatment = "loc", data = temp1_1_did, drop = c("ID","callintegrity"),cutpoints = list(log_contractvalue=valuecuts1_1_did), eval.imbalance = TRUE)
mat1_1_did
...
disaster2_pretreat <- disaster2_pretreat_1 %>% group_by(buyer_name) %>% mutate(meancallintegrity = mean(callintegrity)) #pretreament average of the number of bidders
common2_1<- cbind.data.frame(disaster2_pretreat$buyer_name, disaster2_pretreat$meancallintegrity)
common2_1<- distinct(common2_1)
names(common2_1)[1]<-paste("buyer_name")
names(common2_1)[2]<-paste("meancallintegrity")
...
disaster2_out_pretreat <- disaster2_out_pretreat_1 %>% group_by(buyer_name) %>% mutate(meancallintegrity = mean(callintegrity)) #pretreament average of the number of bidders
common2_1_out<- cbind.data.frame(disaster2_out_pretreat$buyer_name, disaster2_out_pretreat$meancallintegrity)
common2_1_out<- distinct(common2_1_out)
names(common2_1_out)[1]<-paste("buyer_name")
names(common2_1_out)[2]<-paste("meancallintegrity")
...
summary(temp2_0_did$meancallintegrity)
valuecuts2_0_did = c(13.265, 14.294,12,11)
mat2_0_did <- cem(treatment = "loc", data = temp2_0_did, drop = c("ID","callintegrity"),cutpoints = list(log_contractvalue = valuecuts2_0_did),eval.imbalance = TRUE)
mat2_0_did
...
t.test(dis2_mean_in$callintegrity,dis2_mean_out$callintegrity, paired = FALSE, conf.level = 0.90)
...
disaster3_pretreat <- disaster3_pretreat_1 %>% group_by(buyer_name) %>% mutate(meancallintegrity = mean(callintegrity)) #pretreament average of the number of bidders
common3_1<- cbind.data.frame(disaster3_pretreat$buyer_name, disaster3_pretreat$meancallintegrity)
common3_1<- distinct(common3_1)
names(common3_1)[1]<-paste("buyer_name")
names(common3_1)[2]<-paste("meancallintegrity")
...
valuecuts3_0 <- c(20)
mat3_0 <- cem(treatment = "timing", data = temp3_0, drop = c("ID","callintegrity"),cutpoints = list(log_contractvalue = valuecuts3_0), eval.imbalance = TRUE)
mat3_0
...
disaster3_out_pretreat <- disaster3_out_pretreat_1 %>% group_by(buyer_name) %>% mutate(meancallintegrity = mean(callintegrity)) #pretreament average of the number of bidders
common3_1_out<- cbind.data.frame(disaster3_out_pretreat$buyer_name, disaster3_out_pretreat$meancallintegrity)
common3_1_out<- distinct(common3_1_out)
names(common3_1_out)[1]<-paste("buyer_name")
names(common3_1_out)[2]<-paste("meancallintegrity")
...
mat3_0_did <- cem(treatment = "loc", data = temp3_0_did, drop = c("ID","callintegrity"),cutpoints = list(log_contractvalue=valuecuts3_0_did), eval.imbalance = TRUE)
mat3_0_did
...
t.test(dis3_mean_in$callintegrity,dis3_mean_out$callintegrity, paired = FALSE, conf.level = 0.90)
...
mat3_1_did <- cem(treatment = "loc", data = temp3_1_did, drop = c("ID","callintegrity"),cutpoints = list(log_contractvalue=valuecuts3_1_did), eval.imbalance = TRUE)
mat3_1_did
...
disaster4_pretreat <- disaster4_pretreat_1 %>% group_by(buyer_name) %>% mutate(meancallintegrity = mean(callintegrity)) #pretreament average of the number of bidders
common4_1<- cbind.data.frame(disaster4_pretreat$buyer_name, disaster4_pretreat$meancallintegrity)
common4_1<- distinct(common4_1)
names(common4_1)[1]<-paste("buyer_name")
names(common4_1)[2]<-paste("meancallintegrity")
...
summary(temp4_0$meancallintegrity)
...
mat4_0 <- cem(treatment = "timing", data = temp4_0, drop = c("ID","callintegrity"),cutpoints = list(log_contractvalue=valuecuts4_0 ), eval.imbalance = TRUE)
mat4_0
...
disaster4_out_pretreat <- disaster4_out_pretreat_1 %>% group_by(buyer_name) %>% mutate(meancallintegrity = mean(callintegrity)) #pretreament average of the number of bidders
common4_1_out<- cbind.data.frame(disaster4_out_pretreat$buyer_name, disaster4_out_pretreat$meancallintegrity)
common4_1_out<- distinct(common4_1_out)
names(common4_1_out)[1]<-paste("buyer_name")
names(common4_1_out)[2]<-paste("meancallintegrity")
...
summary(temp4_0_did$meancallintegrity)
valuecuts4_0_did = c(13.311,14.30)
meancuts4_0_did = c(0.07,0.245)
mat4_0_did <- cem(treatment = "loc", data = temp4_0_did, drop = c("ID","callintegrity"),cutpoints = list(log_contractvalue=valuecuts4_0_did), eval.imbalance = TRUE)
mat4_0_did
...
summary(temp4_1_did$meancallintegrity)
valuecuts4_1_did = c(13.61,14.82)
meancuts4_1_did = c(0.245)
mat4_1_did <- cem(treatment = "loc", data = temp4_1_did, drop = c("ID","callintegrity"),cutpoints = list(log_contractvalue=valuecuts4_1_did), eval.imbalance = TRUE)
mat4_1_did
...
disaster5_pretreat <- disaster5_pretreat_1 %>% group_by(buyer_name) %>% mutate(meancallintegrity = mean(callintegrity)) #pretreament average of the number of bidders
common5_1<- cbind.data.frame(disaster5_pretreat$buyer_name, disaster5_pretreat$meancallintegrity)
common5_1<- distinct(common5_1)
names(common5_1)[1]<-paste("buyer_name")
names(common5_1)[2]<-paste("meancallintegrity")
...
mat5_0 <- cem(treatment = "timing", data = temp5_0, drop = c("ID","callintegrity"), cutpoints = list(log_contractvalue = valuecuts5_0), grouping = list(contractmonth = month.grp), eval.imbalance = TRUE)
mat5_0
est5_0 <- att(mat5_0, callintegrity ~ timing, data = temp5_0)
est5_0
...
disaster5_out_pretreat <- disaster5_out_pretreat_1 %>% group_by(buyer_name) %>% mutate(meancallintegrity = mean(callintegrity)) #pretreament average of the number of bidders
common5_1_out<- cbind.data.frame(disaster5_out_pretreat$buyer_name, disaster5_out_pretreat$meancallintegrity)
common5_1_out<- distinct(common5_1_out)
names(common5_1_out)[1]<-paste("buyer_name")
names(common5_1_out)[2]<-paste("meancallintegrity")
...
mat5_0_did <- cem(treatment = "loc", data = temp5_0_did, drop = c("ID","callintegrity"), cutpoints = list(log_contractvalue = valuecuts5_0_did),grouping = list(contractmonth = month.grp, buyer_buyerType = buyer_buyerType.grp), eval.imbalance = TRUE)
mat5_0_did
...
t.test(dis5_mean_in$callintegrity,dis5_mean_out$callintegrity, paired = FALSE, conf.level = 0.90)
...
mat5_1_did <- cem(treatment = "loc", data = temp5_1_did, drop = c("ID","callintegrity"), cutpoints = list(log_contractvalue = valuecuts5_1_did), eval.imbalance = TRUE)
mat5_1_did
...
matched_comparison<- t.test(dv1_matched_ttest_post$callintegrity,dv1_matched_ttest_pre$callintegrity, paired = FALSE, conf.level = 0.90)
...
saveRDS(matched_comparison,'tables/robustness/table_22/2_t_test_did_callintegrity.rds')
...
saveRDS(didreg2, 'tables/robustness/table_23/2_callintegrity_did.Rds')
...
saveRDS(summary_coeftest, 'tables/robustness/table_23/2_callintegrity_did_clustered_se.Rds')
