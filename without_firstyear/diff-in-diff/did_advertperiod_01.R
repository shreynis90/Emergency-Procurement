...
italy_disaster1 <- italy_disaster1 %>% #Dropping the Contracts that are missing the dependent variable 
  filter(!is.na(advertintegrity))

italy_disaster1 <- italy_disaster1[!(italy_disaster1$contractdate_final >= as.Date("2009-10-02") & 
                                       italy_disaster1$contractdate_final <= as.Date("2010-10-02")), ]
...
disaster1_pretreat <- disaster1_pretreat_1 %>% group_by(buyer_name) %>% mutate(meanadvertintegrity = mean(advertintegrity)) #pretreament average of the number of bidders
common1_1<- cbind.data.frame(disaster1_pretreat$buyer_name, disaster1_pretreat$meanadvertintegrity)
common1_1<- distinct(common1_1)
names(common1_1)[1]<-paste("buyer_name")
names(common1_1)[2]<-paste("meanadvertintegrity")
...
disaster1_pretreat$contractmonth <- as.factor(disaster1_pretreat$contractmonth)
...
disaster1_posttreat$contractmonth <- as.factor(disaster1_posttreat$contractmonth)
...
#Matching
vars_bf <- c("ID","timing", "tender_mainCpv", "advertintegrity", "log_contractvalue", "meanadvertintegrity")

temp1_0<-disaster1[vars_bf]
vars2_bf<- c("timing", "tender_mainCpv", "log_contractvalue", "meanadvertintegrity","contractmonth","buyer_buyerType")
...
mat1_0 <- cem(treatment = "timing", data = temp1_0, drop = c("ID","advertintegrity"),cutpoints = list(log_contractvalue=valuecuts1_0), eval.imbalance = TRUE)
mat1_0
...
italy_disaster1_out$tender_mainCpv <- sub("^(\\d{3}).*$", "\\1", italy_disaster1_out$tender_mainCpv) #Retaining only the first two digits of the the CPV code
italy_disaster1_out$tender_mainCpv <- as.integer(italy_disaster1_out$tender_mainCpv)
...
italy_disaster1_out <- italy_disaster1_out[!(italy_disaster1_out$contractdate_final >= as.Date("2009-10-02") & 
                                               italy_disaster1_out$contractdate_final <= as.Date("2010-10-02")), ]
...
disaster1_out_pretreat <- disaster1_out_pretreat_1 %>% group_by(buyer_name) %>% mutate(meanadvertintegrity = mean(advertintegrity)) #pretreament average of the number of bidders
common1_1_out<- cbind.data.frame(disaster1_out_pretreat$buyer_name, disaster1_out_pretreat$meanadvertintegrity)
common1_1_out<- distinct(common1_1_out)
names(common1_1_out)[1]<-paste("buyer_name")
names(common1_1_out)[2]<-paste("meanadvertintegrity")
...
vars <- c("ID","loc", "tender_mainCpv", "advertintegrity", "log_contractvalue","buyer_buyerType","contractyear","contractmonth")
...
mat1_0_did <- cem(treatment = "loc", data = temp1_0_did, drop = c("ID","advertintegrity"),cutpoints = list(log_contractvalue=valuecuts1_0_did), eval.imbalance = TRUE)
mat1_0_did
...
mat1_1_did <- cem(treatment = "loc", data = temp1_1_did, drop = c("ID","advertintegrity"),cutpoints = list(log_contractvalue=valuecuts1_1_did), eval.imbalance = TRUE)
mat1_1_did
...
italy_disaster2 <- italy_disaster2 %>% #Dropping the Contracts that are missing the advertintegrity
  filter(!is.na(advertintegrity))
italy_disaster2$contractmonth <- as.factor(italy_disaster2$contractmonth)
italy_disaster2$contractyear <- as.factor(italy_disaster2$contractyear)


italy_disaster2 <- italy_disaster2[!(italy_disaster2$contractdate_final >= as.Date("2012-05-29") & 
                                       italy_disaster2$contractdate_final <= as.Date("2013-05-29")), ]
...
disaster2_pretreat <- disaster2_pretreat_1 %>% group_by(buyer_name) %>% mutate(meanadvertintegrity = mean(advertintegrity)) #pretreament average of the number of bidders
common2_1<- cbind.data.frame(disaster2_pretreat$buyer_name, disaster2_pretreat$meanadvertintegrity)
common2_1<- distinct(common2_1)
names(common2_1)[1]<-paste("buyer_name")
names(common2_1)[2]<-paste("meanadvertintegrity")
...
disaster2_pretreat$contractmonth <- as.factor(disaster2_pretreat$contractmonth)
...
disaster2_posttreat$contractmonth <- as.factor(disaster2_posttreat$contractmonth)
...
italy_disaster2_out$tender_mainCpv <- sub("^(\\d{3}).*$", "\\1", italy_disaster2_out$tender_mainCpv) #Retaining only the first two digits of the the CPV code
italy_disaster2_out$tender_mainCpv <- as.integer(italy_disaster2_out$tender_mainCpv)
...
italy_disaster2_out <- italy_disaster2_out[!(italy_disaster2_out$contractdate_final >= as.Date("2012-05-29") & 
                                               italy_disaster2_out$contractdate_final <= as.Date("2013-05-29")), ]
...
disaster2_out_pretreat <- disaster2_out_pretreat_1 %>% group_by(buyer_name) %>% mutate(meanadvertintegrity = mean(advertintegrity)) #pretreament average of the number of bidders
common2_1_out<- cbind.data.frame(disaster2_out_pretreat$buyer_name, disaster2_out_pretreat$meanadvertintegrity)
common2_1_out<- distinct(common2_1_out)
names(common2_1_out)[1]<-paste("buyer_name")
names(common2_1_out)[2]<-paste("meanadvertintegrity")
...
summary(temp2_0_did$meanadvertintegrity)
valuecuts2_0_did = c(13.265, 14.294,12,11)
mat2_0_did <- cem(treatment = "loc", data = temp2_0_did, drop = c("ID","advertintegrity"),cutpoints = list(log_contractvalue = valuecuts2_0_did),eval.imbalance = TRUE)
mat2_0_did
...
t.test(dis2_mean_in$advertintegrity,dis2_mean_out$advertintegrity, paired = FALSE, conf.level = 0.90)
...
italy_disaster3 <- italy_disaster3[!(italy_disaster3$contractdate_final >= as.Date("2013-11-18") & 
                                       italy_disaster3$contractdate_final <= as.Date("2014-11-18")), ]
...
disaster3_pretreat <- disaster3_pretreat_1 %>% group_by(buyer_name) %>% mutate(meanadvertintegrity = mean(advertintegrity)) #pretreament average of the number of bidders
common3_1<- cbind.data.frame(disaster3_pretreat$buyer_name, disaster3_pretreat$meanadvertintegrity)
common3_1<- distinct(common3_1)
names(common3_1)[1]<-paste("buyer_name")
names(common3_1)[2]<-paste("meanadvertintegrity")
...
disaster3_pretreat$contractmonth<- as.factor(disaster3_pretreat$contractmonth)
disaster3_pretreat$contractday<- as.factor(disaster3_pretreat$contractday)
...
disaster3_posttreat$contractmonth <- as.factor(disaster3_posttreat$contractmonth)
...
valuecuts3_0 <- c(20)
mat3_0 <- cem(treatment = "timing", data = temp3_0, drop = c("ID","advertintegrity"),cutpoints = list(log_contractvalue = valuecuts3_0), eval.imbalance = TRUE)
mat3_0
...
italy_disaster3_out$tender_mainCpv <- sub("^(\\d{3}).*$", "\\1", italy_disaster3_out$tender_mainCpv) #Retaining only the first two digits of the the CPV code
italy_disaster3_out$tender_mainCpv <- as.integer(italy_disaster3_out$tender_mainCpv)
...
italy_disaster3_out <- italy_disaster3_out[!(italy_disaster3_out$contractdate_final >= as.Date("2013-11-18") & 
                                               italy_disaster3_out$contractdate_final <= as.Date("2014-11-18")), ]
...
disaster3_out_pretreat <- disaster3_out_pretreat_1 %>% group_by(buyer_name) %>% mutate(meanadvertintegrity = mean(advertintegrity)) #pretreament average of the number of bidders
common3_1_out<- cbind.data.frame(disaster3_out_pretreat$buyer_name, disaster3_out_pretreat$meanadvertintegrity)
common3_1_out<- distinct(common3_1_out)
names(common3_1_out)[1]<-paste("buyer_name")
names(common3_1_out)[2]<-paste("meanadvertintegrity")
...
valuecuts3_0_did = c(11)
mat3_0_did <- cem(treatment = "loc", data = temp3_0_did, drop = c("ID","advertintegrity"),cutpoints = list(log_contractvalue=valuecuts3_0_did), eval.imbalance = TRUE)
mat3_0_did
...
t.test(dis3_mean_in$advertintegrity,dis3_mean_out$advertintegrity, paired = FALSE, conf.level = 0.90)
...
mat3_1_did <- cem(treatment = "loc", data = temp3_1_did, drop = c("ID","advertintegrity"),cutpoints = list(log_contractvalue=valuecuts3_1_did), eval.imbalance = TRUE)
mat3_1_did
...
italy_disaster4 <- italy_disaster4[!(italy_disaster4$contractdate_final >= as.Date("2016-08-24") & 
                                       italy_disaster4$contractdate_final <= as.Date("2017-08-24")), ]
##Pretreatment average of the dependent variable
...
disaster4_pretreat <- disaster4_pretreat_1 %>% group_by(buyer_name) %>% mutate(meanadvertintegrity = mean(advertintegrity)) #pretreament average of the number of bidders
common4_1<- cbind.data.frame(disaster4_pretreat$buyer_name, disaster4_pretreat$meanadvertintegrity)
common4_1<- distinct(common4_1)
names(common4_1)[1]<-paste("buyer_name")
names(common4_1)[2]<-paste("meanadvertintegrity")
...
disaster4_pretreat$contractmonth <- as.factor(disaster4_pretreat$contractmonth)
...
disaster4_posttreat$contractmonth <- as.factor(disaster4_posttreat$contractmonth)
...
summary(temp4_0$meanadvertintegrity)
valuecuts4_0 = c(13.29,13.76,14.43,15,16)
meancuts4_0 = c(0.031,0.39)
...
mat4_0 <- cem(treatment = "timing", data = temp4_0, drop = c("ID","advertintegrity"),cutpoints = list(log_contractvalue=valuecuts4_0 ), eval.imbalance = TRUE)
mat4_0
...
italy_disaster4_out$tender_mainCpv <- sub("^(\\d{3}).*$", "\\1", italy_disaster4_out$tender_mainCpv) #Retaining only the first two digits of the the CPV code
italy_disaster4_out$tender_mainCpv <- as.integer(italy_disaster4_out$tender_mainCpv)
...
italy_disaster4_out <- italy_disaster4_out[!(italy_disaster4_out$contractdate_final >= as.Date("2016-08-24") & 
                                               italy_disaster4_out$contractdate_final <= as.Date("2017-08-24")), ]
...
disaster4_out_pretreat <- disaster4_out_pretreat_1 %>% group_by(buyer_name) %>% mutate(meanadvertintegrity = mean(advertintegrity)) #pretreament average of the number of bidders
common4_1_out<- cbind.data.frame(disaster4_out_pretreat$buyer_name, disaster4_out_pretreat$meanadvertintegrity)
common4_1_out<- distinct(common4_1_out)
names(common4_1_out)[1]<-paste("buyer_name")
names(common4_1_out)[2]<-paste("meanadvertintegrity")
...
summary(temp4_0_did$meanadvertintegrity)
valuecuts4_0_did = c(13.311,14.30)
meancuts4_0_did = c(0.07,0.245)
mat4_0_did <- cem(treatment = "loc", data = temp4_0_did, drop = c("ID","advertintegrity"),cutpoints = list(log_contractvalue=valuecuts4_0_did), eval.imbalance = TRUE)
mat4_0_did
...
t.test(dis4_mean_in$advertintegrity,dis4_mean_out$advertintegrity, paired = FALSE, conf.level = 0.90)
...
summary(temp4_1_did$meanadvertintegrity)
valuecuts4_1_did = c(13.61,14.82)
meancuts4_1_did = c(0.245)
mat4_1_did <- cem(treatment = "loc", data = temp4_1_did, drop = c("ID","advertintegrity"),cutpoints = list(log_contractvalue=valuecuts4_1_did), eval.imbalance = TRUE)
mat4_1_did
...
italy_disaster5 <- italy_disaster5[!(italy_disaster5$contractdate_final >= as.Date("2017-01-18") & 
                                       italy_disaster5$contractdate_final <= as.Date("2018-01-18")), ]
...
disaster5_pretreat <- disaster5_pretreat_1 %>% group_by(buyer_name) %>% mutate(meanadvertintegrity = mean(advertintegrity)) #pretreament average of the number of bidders
common5_1<- cbind.data.frame(disaster5_pretreat$buyer_name, disaster5_pretreat$meanadvertintegrity)
common5_1<- distinct(common5_1)
names(common5_1)[1]<-paste("buyer_name")
names(common5_1)[2]<-paste("meanadvertintegrity")
...
disaster5_pretreat$contractmonth <- as.factor(disaster5_pretreat$contractmonth)
...
disaster5_posttreat$contractmonth <- as.factor(disaster5_posttreat$contractmonth)
...
valuecuts5_0 <- c(10,11.85,14.08,14.95,15.56,14,13,16,16.5,17,12.8,12.6,14.18)
month.grp <- list(c("1"),c("2"),c("3"),c("4"), c("5"),c("6"), c("7", "8","9"),c("10"),c("11"),c("12"))
mat5_0 <- cem(treatment = "timing", data = temp5_0, drop = c("ID","advertintegrity"), cutpoints = list(log_contractvalue = valuecuts5_0), eval.imbalance = TRUE)
mat5_0
...
italy_disaster5_out$tender_mainCpv <- sub("^(\\d{3}).*$", "\\1", italy_disaster5_out$tender_mainCpv) #Retaining only the first two digits of the the CPV code
italy_disaster5_out$tender_mainCpv <- as.integer(italy_disaster5_out$tender_mainCpv)
...
italy_disaster5_out <- italy_disaster5_out %>% #Dropping the Contracts that are missing the number of bidders 
  filter(!is.na(advertintegrity))
italy_disaster5_out <- italy_disaster5_out[!(italy_disaster5_out$contractdate_final >= as.Date("2017-01-18") & 
                                               italy_disaster5_out$contractdate_final <= as.Date("2018-01-18")), ]
...
disaster5_out_pretreat <- disaster5_out_pretreat_1 %>% group_by(buyer_name) %>% mutate(meanadvertintegrity = mean(advertintegrity)) #pretreament average of the number of bidders
common5_1_out<- cbind.data.frame(disaster5_out_pretreat$buyer_name, disaster5_out_pretreat$meanadvertintegrity)
common5_1_out<- distinct(common5_1_out)
names(common5_1_out)[1]<-paste("buyer_name")
names(common5_1_out)[2]<-paste("meanadvertintegrity")
...
temp5_0_did<-disaster5_in_out_pretreat[vars]
temp5_0_did<- as.data.frame(temp5_0_did)
summary(temp5_0_did$log_contractvalue)
valuecuts5_0_did <- c(13.59,13.58,13.6,14.361, 14.4, 14,13.7,15.61,15)
month.grp <- list(c("1"),c( "2","3"),c("4","5","6"), c("7", "8","9","10", "11","12"),c(NA))
buyer_buyerType.grp<- list(c("REGIONAL_AUTHORITY", "REGIONAL_AGENCY"), c("UTILITIES"), c("NATIONAL_AUTHORITY"), c("OTHER"),c("PUBLIC_BODY","NA"))
mat5_0_did <- cem(treatment = "loc", data = temp5_0_did, drop = c("ID","advertintegrity"), cutpoints = list(log_contractvalue = valuecuts5_0_did),grouping = list(contractmonth = month.grp, buyer_buyerType = buyer_buyerType.grp), eval.imbalance = TRUE)
mat5_0_did
...
t.test(dis5_mean_in$advertintegrity,dis5_mean_out$advertintegrity, paired = FALSE, conf.level = 0.90)
...
temp5_1_did<-disaster5_in_out_posttreat[vars]
temp5_1_did<- as.data.frame(temp5_1_did)

summary(temp5_1_did$log_contractvalue)
valuecuts5_1_did <- c(13.60,14.83,16.11)
mat5_1_did <- cem(treatment = "loc", data = temp5_1_did, drop = c("ID","advertintegrity"), cutpoints = list(log_contractvalue = valuecuts5_1_did), eval.imbalance = TRUE)
mat5_1_did
...
dv1_matched_ttest_0<- transform(dv1, freq.loc = ave(seq(nrow(dv1)), buyer_name, FUN=length))
dv1_matched_ttest<- dv1_matched_ttest_0 %>% filter(freq.loc>1)


dv1_matched_ttest_pre <- dv1_matched_ttest %>% filter(timing == 0)
dv1_matched_ttest_post <- dv1_matched_ttest%>% filter(timing == 1)
...
t.test(dv4_pre_in$advertintegrity,dv4_pre_out$advertintegrity, paired = FALSE, conf.level = 0.90)
...
t.test(d_oneyearpost$advertintegrity)
t.test(d_oneyearpre$advertintegrity)
...
mean(d_twoyear$advertintegrity)
...
t.test(d_twoyearpost$advertintegrity)
t.test(d_twoyearpre$advertintegrity)
...
d_threeyear_2<- d_threeyear_1 %>% filter(freq.loc>1)


d_threeyearpre <- d_threeyear_2 %>% filter(timing == 0)
d_threeyearpost <- d_threeyear_2 %>% filter(timing == 1)
t.test(d_threeyearpost$advertintegrity)
t.test(d_threeyearpre$advertintegrity)

##
year <- c("t =-3", "t =-2", "t =-1","t = 1","t = 2","t = 3")
meanadvertintegrity <- c(t.test(d_threeyearpre$advertintegrity)$'estimate', t.test(d_twoyearpre$advertintegrity)$'estimate',t.test(d_oneyearpre$advertintegrity)$'estimate',t.test(d_oneyearpost$advertintegrity)$'estimate',t.test(d_twoyearpost$advertintegrity)$'estimate',t.test(d_threeyearpost$advertintegrity)$'estimate')

lowerbound <- c(t.test(d_threeyearpre$advertintegrity)$'conf.int'[1],t.test(d_twoyearpre$advertintegrity)$'conf.int'[1],t.test(d_oneyearpre$advertintegrity)$'conf.int'[1],t.test(d_oneyearpost$advertintegrity)$'conf.int'[1],t.test(d_twoyearpost$advertintegrity)$'conf.int'[1],t.test(d_threeyearpost$advertintegrity)$'conf.int'[1])

upperbound <- c(t.test(d_threeyearpre$advertintegrity)$'conf.int'[2],t.test(d_twoyearpre$advertintegrity)$'conf.int'[2],t.test(d_oneyearpre$advertintegrity)$'conf.int'[2],t.test(d_oneyearpost$advertintegrity)$'conf.int'[2],t.test(d_twoyearpost$advertintegrity)$'conf.int'[2],t.test(d_threeyearpost$advertintegrity)$'conf.int'[2])

df <- data.frame(year, meanadvertintegrity, lowerbound,upperbound)

df$year <- factor(df$year, levels = df$year)
p <- ggplot(df, aes(year, as.numeric(as.character(meanadvertintegrity)))) +        # ggplot2 plot with confidence intervals
  ...
  annotate(geom = "text",
           ...
           y = 0.3,
           angle = 90, 
           vjust = 26) +ylab("Too-short advertisement period")
