...
#Matching
vars_bf <- c("timing", "tender_mainCpv", "advertintegrity", "log_contractvalue", "meanadvertintegrity","contractmonth","buyer_buyerType")

temp1_0<-disaster1[vars_bf]
vars2_bf<- c("log_contractvalue","meanadvertintegrity")
...
disaster1_in_pretreat = subset(disaster1_in_pretreat0, select = -c(aftermatchweight,aftermatchtreat,meanadvertintegrity) )

disaster1_in_out_pretreat <- rbind(disaster1_out_pretreat0,disaster1_in_pretreat) 

vars <- c("loc", "tender_mainCpv", "advertintegrity", "log_contractvalue","contractmonth","buyer_buyerType")
...
mat1_0_did <- cem(treatment = "loc", data = temp1_0_did, drop = "advertintegrity",cutpoints = list(log_contractvalue=valuecuts1_0_did), eval.imbalance = TRUE)
mat1_0_did
mat1_0_did$w
...
disaster1_in_posttreat = subset(disaster1_in_posttreat0, select = -c(aftermatchweight,aftermatchtreat,meanadvertintegrity) )
...
mat1_1_did <- cem(treatment = "loc", data = temp1_1_did, drop = "advertintegrity",cutpoints = list(log_contractvalue=valuecuts1_1_did), eval.imbalance = TRUE)
mat1_1_did
mat1_1_did$w
...
disaster2_in_pretreat = subset(disaster2_in_pretreat0, select = -c(aftermatchweight,aftermatchtreat,meanadvertintegrity) )
...
mat2_0_did <- cem(treatment = "loc", data = temp2_0_did, drop = "advertintegrity",cutpoints = list(log_contractvalue=valuecuts2_0_did), eval.imbalance = TRUE)
mat2_0_did
mat2_0_did$w
...
disaster2_in_posttreat = subset(disaster2_in_posttreat0, select = -c(aftermatchweight,aftermatchtreat,meanadvertintegrity) )
...
mat2_1_did <- cem(treatment = "loc", data = temp2_1_did, drop = "advertintegrity",cutpoints = list(log_contractvalue=valuecuts2_1_did), eval.imbalance = TRUE)
mat2_1_did
mat2_1_did$w
...
disaster3_in_pretreat = subset(disaster3_in_pretreat0, select = -c(aftermatchweight,aftermatchtreat,meanadvertintegrity) )
...
mat3_0_did <- cem(treatment = "loc", data = temp3_0_did, drop = "advertintegrity",cutpoints = list(log_contractvalue=valuecuts3_0_did), eval.imbalance = TRUE)
mat3_0_did
mat3_0_did$w
...
disaster3_in_posttreat = subset(disaster3_in_posttreat0, select = -c(aftermatchweight,aftermatchtreat,meanadvertintegrity) )
...
mat3_1_did <- cem(treatment = "loc", data = temp3_1_did, drop = "advertintegrity",cutpoints = list(log_contractvalue=valuecuts3_1_did), eval.imbalance = TRUE)
mat3_1_did
mat3_1_did$w
...
disaster4_in_pretreat = subset(disaster4_in_pretreat0, select = -c(aftermatchweight,aftermatchtreat,meanadvertintegrity) )
...
mat4_0_did <- cem(treatment = "loc", data = temp4_0_did, drop = "advertintegrity",cutpoints = list(log_contractvalue=valuecuts4_0_did), eval.imbalance = TRUE)
mat4_0_did
mat4_0_did$w
...
disaster4_in_posttreat = subset(disaster4_in_posttreat0, select = -c(aftermatchweight,aftermatchtreat,meanadvertintegrity) )
...
mat4_1_did <- cem(treatment = "loc", data = temp4_1_did, drop = "advertintegrity",cutpoints = list(log_contractvalue=valuecuts4_1_did), eval.imbalance = TRUE)
mat4_1_did
mat4_1_did$w
...
disaster5_in_pretreat = subset(disaster5_in_pretreat0, select = -c(aftermatchweight,aftermatchtreat,meanadvertintegrity) )
...
mat5_0_did <- cem(treatment = "loc", data = temp5_0_did, drop = "advertintegrity",cutpoints = list(log_contractvalue=valuecuts5_0_did), eval.imbalance = TRUE)
mat5_0_did
mat5_0_did$w
...
disaster5_in_posttreat = subset(disaster5_in_posttreat0, select = -c(aftermatchweight,aftermatchtreat,meanadvertintegrity) )
...
mat5_1_did <- cem(treatment = "loc", data = temp5_1_did, drop = "advertintegrity",cutpoints = list(log_contractvalue=valuecuts5_1), eval.imbalance = TRUE)
mat5_1_did
mat5_1_did$w
...
matched_comparison<- t.test(dv1_post$advertintegrity,dv1_pre$advertintegrity, paired = FALSE, conf.level = 0.90)
matched_comparison

##Diff-in-diff ----

dv2 <- rbind(disaster1_did_final, disaster2_did_final, disaster3_did_final, disaster4_did_final, disaster5_did_final)
didreg = lm(advertintegrity ~ loc*timing, data = dv2)
summary(didreg)
