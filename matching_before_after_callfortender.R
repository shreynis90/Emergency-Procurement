...
vars2<- c("tender_mainCpv", "log_contractvalue", "meancallintegrity")
...
vars2<- c("timing", "log_contractvalue", "meancallintegrity")
...
matched_comparison<- t.test(dv1_pre$callintegrity,dv1_post$callintegrity, paired = FALSE, conf.level = 0.90)
matched_comparison
