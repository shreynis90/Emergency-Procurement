...
#Matching
vars <- c("timing", "tender_mainCpv", "procedureintegrity", "log_contractvalue", "meanprocedureintegrity","contractmonth")
...
mat1_0 <- cem(treatment = "timing", data = temp1_0, drop = "procedureintegrity",cutpoints = list(log_contractvalue=valuecuts1_0))
mat1_0
mat1_0$w
...
mat2_0 <- cem(treatment = "timing", data = temp2_0, drop = "procedureintegrity",cutpoints = list(log_contractvalue=valuecuts2_0))
mat2_0
...
mat3_0 <- cem(treatment = "timing", data = temp3_0, drop = "procedureintegrity",cutpoints = list(log_contractvalue=valuecuts3_0))
mat3_0
...
buyer_buyerType.grp<- list(c("REGIONAL_AUTHORITY", "REGIONAL_AGENCY", "UTILITIES"), c("NATIONAL_AUTHORITY"),c("OTHER"), c("PUBLIC_BODY"), c("NA",NA))
mat4_0 <- cem(treatment = "timing", data = temp4_0, drop = "procedureintegrity",cutpoints = list(log_contractvalue=valuecuts4_0))
mat4_0
...
buyer_buyerType.grp<- list(c("REGIONAL_AUTHORITY", "REGIONAL_AGENCY", "UTILITIES"), c("NATIONAL_AUTHORITY"),c("OTHER"), c("PUBLIC_BODY"), c("NA",NA))
mat5_0 <- cem(treatment = "timing", data = temp5_0, drop = "procedureintegrity",cutpoints = list(log_contractvalue=valuecuts5_0))
mat5_0
...
dv1 <- rbind(disaster1_final, disaster2_final, disaster3_final, disaster4_final, disaster5_final)
  ...
  dv1_did<- glm(procedureintegrity ~ timing, data = dv1, family="binomial", weights = aftermatchweight)
summary.glm(dv1_did)
table(dv1$timing)
RsqGLM(dv1_did)
