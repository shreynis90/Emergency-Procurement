...
#Matching
vars <- c("treatcon","buyer_buyerType", "tender_mainCpv", "callintegrity", "log_contractvalue", "meancallintegrity", "contractyear")
temp1_0<-disaster1_pretreat[vars]
vars2<- c("buyer_buyerType", "tender_mainCpv", "log_contractvalue","contractyear", "meancallintegrity")
...
mat1_0 <- cem(treatment = "treatcon", data = temp1_0, drop = "callintegrity",cutpoints = list(log_contractvalue=valuecuts1_0), grouping = list(buyer_buyerType= buyer_buyerType.grp))
mat1_0
mat1_0$w
est1_0 <- att(mat1_0, callintegrity ~ treatcon, data = temp1_0)
est1_0
...
vars2<- c("buyer_buyerType", "tender_mainCpv", "log_contractvalue", "meancallintegrity","contractyear")
...
buyer_buyerType.grp<- list(c("REGIONAL_AUTHORITY", "REGIONAL_AGENCY", "UTILITIES"), c("NATIONAL_AUTHORITY"),c("OTHER"), c("PUBLIC_BODY"), c("NA",NA))
mat1_1 <- cem(treatment = "treatcon", data = temp1_1, drop = "callintegrity",cutpoints = list(log_contractvalue=valuecuts1_1), grouping = list(buyer_buyerType= buyer_buyerType.grp))
mat1_1
est1_1 <- att(mat1_1, callintegrity ~ treatcon, data = temp1_1)
est1_1
...
disaster1_did<- glm(callintegrity ~ treatcon + timing + did, data = disaster1_matched, family="binomial", weights = aftermatchweight)
...
vars2<- c("buyer_buyerType", "tender_mainCpv", "log_contractvalue", "meancallintegrity","contractyear")
vars3<- c("log_contractvalue","meancallintegrity","contractyear","tender_mainCpv")
...
buyer_buyerType.grp<- list(c("REGIONAL_AUTHORITY", "REGIONAL_AGENCY", "UTILITIES"), c("NATIONAL_AUTHORITY"),c("OTHER"), c("PUBLIC_BODY"), c("NA",NA))
mat2_0 <- cem(treatment = "treatcon", data = temp2_0, drop = "callintegrity",cutpoints = list(log_contractvalue=valuecuts2_0),grouping = list(buyer_buyerType= buyer_buyerType.grp))
mat2_0
est2_0 <- att(mat2_0, callintegrity ~ treatcon, data = temp2_0)
est2_0
...
buyer_buyerType.grp<- list(c("REGIONAL_AUTHORITY", "REGIONAL_AGENCY", "UTILITIES"), c("NATIONAL_AUTHORITY"),c("OTHER"), c("PUBLIC_BODY"), c("NA",NA))
mat2_1 <- cem(treatment = "treatcon", data = temp2_1, drop = "callintegrity",cutpoints = list(log_contractvalue=valuecuts2_1), grouping = list(buyer_buyerType= buyer_buyerType.grp))
mat2_1
est2_1 <- att(mat2_1, callintegrity ~ treatcon, data = temp2_1)
est2_1
...
disaster2_did<- glm(callintegrity ~ treatcon + timing + did, data = disaster2_matched, family="binomial", weights = aftermatchweight)
...
buyer_buyerType.grp<- list(c("REGIONAL_AUTHORITY", "REGIONAL_AGENCY", "UTILITIES"), c("NATIONAL_AUTHORITY"),c("OTHER"), c("PUBLIC_BODY"), c("NA",NA))
mat3_0 <- cem(treatment = "treatcon", data = temp3_0, drop = "callintegrity",cutpoints = list(log_contractvalue=valuecuts3_0), grouping = list(buyer_buyerType= buyer_buyerType.grp))
mat3_0
est3_0 <- att(mat3_0, callintegrity ~ treatcon, data = temp3_0)
est3_0
...
buyer_buyerType.grp<- list(c("REGIONAL_AUTHORITY", "REGIONAL_AGENCY", "UTILITIES"), c("NATIONAL_AUTHORITY"),c("OTHER"), c("PUBLIC_BODY"), c("NA",NA))
mat3_1 <- cem(treatment = "treatcon", data = temp3_1, drop = "callintegrity",cutpoints = list(log_contractvalue=valuecuts3_1), grouping = list(buyer_buyerType= buyer_buyerType.grp))
mat3_1
est3_1 <- att(mat3_1, callintegrity ~ treatcon, data = temp3_1)
est3_1
...
disaster3_did<- glm(callintegrity ~ treatcon + timing + did, data = disaster3_matched,family="binomial", weights = aftermatchweight)
...
buyer_buyerType.grp<- list(c("REGIONAL_AUTHORITY", "REGIONAL_AGENCY", "UTILITIES"), c("NATIONAL_AUTHORITY"),c("OTHER"), c("PUBLIC_BODY"), c("NA",NA))
mat4_0 <- cem(treatment = "treatcon", data = temp4_0, drop = "callintegrity",cutpoints = list(log_contractvalue=valuecuts4_0), grouping = list(buyer_buyerType= buyer_buyerType.grp))
mat4_0
est4_0 <- att(mat4_0, callintegrity ~ treatcon, data = temp4_0)
est4_0
...
buyer_buyerType.grp<- list(c("REGIONAL_AUTHORITY", "REGIONAL_AGENCY", "UTILITIES"), c("NATIONAL_AUTHORITY"),c("OTHER"), c("PUBLIC_BODY"), c("NA",NA))
mat4_1 <- cem(treatment = "treatcon", data = temp4_1, drop = "callintegrity",cutpoints = list(log_contractvalue=valuecuts4_1), grouping = list(buyer_buyerType= buyer_buyerType.grp))
mat4_1
est4_1 <- att(mat4_1, callintegrity ~ treatcon, data = temp4_1)
est4_1
...
disaster4_did<- glm(callintegrity ~ treatcon + timing + did, data = disaster4_matched, family ="binomial",weights = aftermatchweight)
...
buyer_buyerType.grp<- list(c("REGIONAL_AUTHORITY", "REGIONAL_AGENCY", "UTILITIES"), c("NATIONAL_AUTHORITY"),c("OTHER"), c("PUBLIC_BODY"), c("NA",NA))
mat5_0 <- cem(treatment = "treatcon", data = temp5_0, drop = "callintegrity",cutpoints = list(log_contractvalue=valuecuts5_0), grouping = list(buyer_buyerType= buyer_buyerType.grp))
mat5_0
est5_0 <- att(mat5_0, callintegrity ~ treatcon, data = temp5_0)
est5_0
...
mat5_1 <- cem(treatment = "treatcon", data = temp5_1, drop = "callintegrity",cutpoints = list(log_contractvalue=valuecuts5_1), grouping = list(buyer_buyerType= buyer_buyerType.grp))
mat5_1
est5_1 <- att(mat5_1, callintegrity ~ treatcon, data = temp5_1)
est5_1
...
disaster5_did<- glm(callintegrity ~ treatcon + timing + did, data = disaster5_matched,family="binomial", weights = aftermatchweight)
...
dv1_did<- glm(callintegrity ~ treatcon + timing + did, data = dv1,family="binomial", weights = aftermatchweight)
summary.glm(dv1_did)
table(dv1$treatcon)
RsqGLM(dv1_did)
