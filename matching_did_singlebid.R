...
#Matching
vars_bf <- c("timing", "tender_mainCpv", "totalbiddersintegrity", "log_contractvalue", "meantotalbiddersintegrity","contractmonth","buyer_buyerType")

temp1_0<-disaster1[vars_bf]
vars2_bf<- c("log_contractvalue","meantotalbiddersintegrity")
...
mat1_0 <- cem(treatment = "timing", data = temp1_0, drop = "totalbiddersintegrity",cutpoints = list(log_contractvalue=valuecuts1_0), eval.imbalance = TRUE)
mat1_0
mat1_0$w
...
disaster1_in_pretreat = subset(disaster1_in_pretreat0, select = -c(aftermatchweight,aftermatchtreat,meantotalbiddersintegrity) )

disaster1_in_out_pretreat <- rbind(disaster1_out_pretreat0,disaster1_in_pretreat) 

vars <- c("loc", "tender_mainCpv", "totalbiddersintegrity", "log_contractvalue","contractmonth","buyer_buyerType")
...
valuecuts1_0_did = c(13.030,13.954,15.094)
mat1_0_did <- cem(treatment = "loc", data = temp1_0_did, drop = "totalbiddersintegrity",cutpoints = list(log_contractvalue=valuecuts1_0_did), eval.imbalance = TRUE)
mat1_0_did
mat1_0_did$w
...
disaster1_in_posttreat = subset(disaster1_in_posttreat0, select = -c(aftermatchweight,aftermatchtreat,meantotalbiddersintegrity) )
...
valuecuts1_1_did = c(13.268,14.274,15.564)
mat1_1_did <- cem(treatment = "loc", data = temp1_1_did, drop = "totalbiddersintegrity",cutpoints = list(log_contractvalue=valuecuts1_1_did), eval.imbalance = TRUE)
mat1_1_did
mat1_1_did$w
...
mat2_0 <- cem(treatment = "timing", data = temp2_0, drop = "totalbiddersintegrity",cutpoints = list(log_contractvalue=valuecuts2_0), eval.imbalance = TRUE)
mat2_0
...
disaster2_in_pretreat = subset(disaster2_in_pretreat0, select = -c(aftermatchweight,aftermatchtreat,meantotalbiddersintegrity) )
...
valuecuts2_0_did = c(13.097,14.098, 15.274)
mat2_0_did <- cem(treatment = "loc", data = temp2_0_did, drop = "totalbiddersintegrity",cutpoints = list(log_contractvalue=valuecuts2_0_did), eval.imbalance = TRUE)
mat2_0_did
mat2_0_did$w
...
disaster2_in_posttreat = subset(disaster2_in_posttreat0, select = -c(aftermatchweight,aftermatchtreat,meantotalbiddersintegrity) )
...
valuecuts2_1_did = c(13.30,14.32,15.62)
mat2_1_did <- cem(treatment = "loc", data = temp2_1_did, drop = "totalbiddersintegrity",cutpoints = list(log_contractvalue=valuecuts2_1_did), eval.imbalance = TRUE)
mat2_1_did
mat2_1_did$w
...
mat3_0 <- cem(treatment = "timing", data = temp3_0, drop = "totalbiddersintegrity",cutpoints = list(log_contractvalue=valuecuts3_0), eval.imbalance = TRUE)
mat3_0
...
disaster3_in_pretreat = subset(disaster3_in_pretreat0, select = -c(aftermatchweight,aftermatchtreat,meantotalbiddersintegrity) )
...
valuecuts3_0_did = c(13.137,14.116,15.336)
mat3_0_did <- cem(treatment = "loc", data = temp3_0_did, drop = "totalbiddersintegrity",cutpoints = list(log_contractvalue=valuecuts3_0_did), eval.imbalance = TRUE)
mat3_0_did
mat3_0_did$w
...
disaster3_in_posttreat = subset(disaster3_in_posttreat0, select = -c(aftermatchweight,aftermatchtreat,meantotalbiddersintegrity) )
...
valuecuts3_1_did = c(13.31,14.36,15.68)
mat3_1_did <- cem(treatment = "loc", data = temp3_1_did, drop = "totalbiddersintegrity",cutpoints = list(log_contractvalue=valuecuts3_1_did), eval.imbalance = TRUE)
mat3_1_did
mat3_1_did$w
...
buyer_buyerType.grp<- list(c("REGIONAL_AUTHORITY", "REGIONAL_AGENCY", "UTILITIES"), c("NATIONAL_AUTHORITY"),c("OTHER"), c("PUBLIC_BODY"), c("NA",NA))
mat4_0 <- cem(treatment = "timing", data = temp4_0, drop = "totalbiddersintegrity",cutpoints = list(log_contractvalue=valuecuts4_0), eval.imbalance = TRUE)
mat4_0
...
disaster4_in_pretreat = subset(disaster4_in_pretreat0, select = -c(aftermatchweight,aftermatchtreat,meantotalbiddersintegrity) )
...
valuecuts4_0_did = c(13.176,14.178,15.378)
mat4_0_did <- cem(treatment = "loc", data = temp4_0_did, drop = "totalbiddersintegrity",cutpoints = list(log_contractvalue=valuecuts4_0_did), eval.imbalance = TRUE)
mat4_0_did
mat4_0_did$w
...
disaster4_in_posttreat = subset(disaster4_in_posttreat0, select = -c(aftermatchweight,aftermatchtreat,meantotalbiddersintegrity) )
...
valuecuts4_1_did = c(13.35,14.82,15.79)
mat4_1_did <- cem(treatment = "loc", data = temp4_1_did, drop = "totalbiddersintegrity",cutpoints = list(log_contractvalue=valuecuts4_1_did), eval.imbalance = TRUE)
mat4_1_did
mat4_1_did$w
...
imbalance(group=temp5_0$timing, data=temp5_0[vars2_bf])
summary(temp5_0$log_contractvalue)
valuecuts5_0 = c(13.24,14.95,14.92)
buyer_buyerType.grp<- list(c("REGIONAL_AUTHORITY", "REGIONAL_AGENCY", "UTILITIES"), c("NATIONAL_AUTHORITY"),c("OTHER"), c("PUBLIC_BODY"), c("NA",NA))
mat5_0 <- cem(treatment = "timing", data = temp5_0, drop = "totalbiddersintegrity",cutpoints = list(log_contractvalue=valuecuts5_0), eval.imbalance = TRUE)
mat5_0
...
disaster5_in_pretreat = subset(disaster5_in_pretreat0, select = -c(aftermatchweight,aftermatchtreat,meantotalbiddersintegrity) )
...
valuecuts5_0_did = c(13.202,14.219,15.427)
mat5_0_did <- cem(treatment = "loc", data = temp5_0_did, drop = "totalbiddersintegrity",cutpoints = list(log_contractvalue=valuecuts5_0_did), eval.imbalance = TRUE)
mat5_0_did
mat5_0_did$w
...
disaster5_in_posttreat = subset(disaster5_in_posttreat0, select = -c(aftermatchweight,aftermatchtreat,meantotalbiddersintegrity) )
...
valuecuts5_1 = c(13.31,14.80,15.75)
mat5_1_did <- cem(treatment = "loc", data = temp5_1_did, drop = "totalbiddersintegrity",cutpoints = list(log_contractvalue=valuecuts5_1), eval.imbalance = TRUE)
mat5_1_did
mat5_1_did$w
...
didreg = lm(totalbiddersintegrity ~ loc*timing, data = dv2)
summary(didreg)
