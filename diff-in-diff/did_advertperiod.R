...
saveRDS(matched_comparison,'tables/table_8/3_t_test_did_advertperiod.rds')
...
saveRDS(matched_comparison_oneyear,'tables/table_14/3_t_test_did_advertperiod.rds')
...
saveRDS(matched_comparison_threeyear,'tables/table_13/3_t_test_did_advertperiod.rds')
